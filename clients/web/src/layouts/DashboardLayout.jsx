        ...
        <aside className="hidden md:block md:col-span-3 lg:col-span-2 border-r border-neutral-800 bg-neutral-900/60 sticky top-0 h-screen overflow-hidden">
          <div className="h-full flex flex-col">
            ...
            <div className="px-4 h-14 border-b border-neutral-800 flex items-center gap-2">
              ...
              <span className="font-semibold tracking-wide">Sarpras</span>
            </div>
            {/* Nav */}
            <nav className="p-3 space-y-1">
              ...
              <NavLink to="/dashboard" end className={linkClass}>
                <House className="size-4 text-neutral-400" />
                <span>Dashboard</span>
              </NavLink>
              <NavLink to="/dashboard/riwayat" className={linkClass}>
                <History className="size-4 text-neutral-400" />
                <span>Riwayat Pengaduan</span>
              </NavLink>
              <NavLink to="/dashboard/tambah" className={linkClass}>
              ...
              <BreadcrumbList>
                ...
                {location.pathname !== "/dashboard" && (
                  <>
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
                      {location.pathname.startsWith("/dashboard/riwayat") && (
                        <BreadcrumbPage>Riwayat Pengaduan</BreadcrumbPage>
                      )}
                      {location.pathname.startsWith("/dashboard/tambah") && (
                        <BreadcrumbPage>Tambah Pengaduan</BreadcrumbPage>
                      )}
                    </BreadcrumbItem>
                  </>
                )}
      ...
      <Sheet open={navOpen} onOpenChange={setNavOpen}>
        ...
        >
          ...
          <SheetHeader className="sr-only">
            ...
            <SheetDescription>Menu navigasi dashboard</SheetDescription>
          </SheetHeader>
